//WID(11/6/2026)(Sarthak Mittal)(DegamieSign)(FireBaseCOnfig)
...
public class FireBaseConfig {
    public void setFireBaseOptions(FireBaseOptions options){this.options=options;}//bindinig FireBaseCoptions In Game Server
